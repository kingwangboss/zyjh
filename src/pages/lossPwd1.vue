            ...
            <div class="content">
                <form @submit.prevent="submit">
                    <div class="bottom">
                        <div class="div-bor">
                            <i class="icon-user"></i>
                            <input class="input" v-model="user.username" type="text" maxlength="20" placeholder="手机号码/用户名" @input="inputFuction"></input>
                        </div>
                        ...
                        <div style="display:flex; align-items: middle;">
                            ...
                            <div class="div-bor1">
                                ...
                                <input class="input1" type="text" v-model="user.verify" maxlength="4" placeholder="请输入验证码" @input="inputFuction">
